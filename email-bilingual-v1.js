document.addEventListener("DOMContentLoaded", function () {
  ...
  emailBtn.addEventListener("click", async function () {
    ...
    if (!phone) {
      alert(
        isEnglish()
          ? "Please enter a phone number so the shop can confirm your email order."
    ...
    try {
      ...
      successBox.textContent = isEnglish()
        ? "Your order has been sent by Email and is awaiting confirmation. The shop will contact you as soon as possible using the phone number you provided."
      ...
      alert(
        isEnglish()
          ? "Email could not be sent. Please try again or send your order via Messenger."
